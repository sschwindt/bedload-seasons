...
def heatmap(
    ...
    corr_method='pearson', clean_data=False
):
    """
    ...
    :param bool clean_data: disables (by default) the elimination of relevant data
    :return: The plot axis.
    """
    ...
    print('* using %s correlation method' % str(corr_method))
